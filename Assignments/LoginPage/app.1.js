...
app.use(session({ // Sessions using express sessions. Note - Express-session vs Cookies-session - https://stackoverflow.com/questions/23566555/whats-difference-with-express-session-and-cookie-session
    cookieName: 'session',
    resave: false,
